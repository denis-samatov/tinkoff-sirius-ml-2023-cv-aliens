...
Для запуска блокнота по обогащению тегов требуется запустить блокнот [tinkoff-sirius-ml-2023-cv-aliens](https://github.com/DmitryRedko/tinkoff-sirius-ml-2023-cv-aliens/tree/master).&#x20;
