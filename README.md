...
* В результате обогащения данных были достигнуты хорошие результаты. Алгоритм обогащения тегами, описанный в блокноте ipynb, привел к тому, что описание удалось присвоить всем фотографиям, кроме шести из 186. Это считается успешным результатом. Затруднения с присвоением описаний шести фотографиям были связаны с ограниченным количеством доступных тегов. При добавлении более обширных тематических тегов, связанных с отельной индустрией, вероятно, удастся присвоить описания всем фотографиям.
